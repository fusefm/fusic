...
BEGIN_MESSAGE_MAP(CColourListBox, CListCtrl)
    //{{AFX_MSG_MAP(CColourListBox)
    ON_NOTIFY_REFLECT(NM_CUSTOMDRAW, OnCustomdraw)
	ON_WM_DESTROY()
    //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CColourListBox::OnDestroy()
...
// ****************
//
int CColourListBox::InsertItem( const LVITEM* pItem )
...
int CColourListBox::InsertItem( UINT nMask, int nItem, LPCTSTR lpszItem, UINT nState, UINT nStateMask, int nImage, LPARAM lParam )
{
...
int CColourListBox::InsertItem( int nItem, LPCTSTR lpszItem )
{ return (this->InsertItem(LVIF_TEXT,nItem,lpszItem,0,0,0,0)); }

int CColourListBox::InsertItem( int nItem, LPCTSTR lpszItem, int nImage )
...
BOOL CColourListBox::SetItem( const LVITEM* pItem )
{
...
BOOL CColourListBox::SetItem(int nItem,int nSubItem,UINT nMask,LPCTSTR lpszItem,int nImage,UINT nState,UINT nStateMask,LPARAM lParam)
{	return (this->SetItem(nItem,nSubItem,nMask,lpszItem,nImage,nState,nStateMask,lParam,0)); }

BOOL CColourListBox::SetItem(int nItem,int nSubItem,UINT nMask,LPCTSTR lpszItem,int nImage,UINT nState,UINT nStateMask,LPARAM lParam,int nIndent)
{
	// So we must create an LVItem and insert it
	LVITEM lvitem;
	lvitem.mask = nMask;
...
// ** DeleteItem **
// ****************
BOOL CColourListBox::DeleteItem( int nItem )
{
...
BOOL CColourListBox::DeleteAllItems()
{
	// Get number of Rows
	//
...
// ** Get/SetItemData **
// *********************
DWORD CColourListBox::GetItemData( int nItem )
...
BOOL CColourListBox::SetItemData( int nItem, DWORD dwData )
{
	// Retrieve the LS_item structure
	//
	LVITEM pItem;
...
// ** GetItem **
// *************
BOOL CColourListBox::GetItem( LV_ITEM* pItem )
{
	/*
...
// *********************************
int CColourListBox::InsertColumn( int nCol, const LVCOLUMN* pColumn )
{
...
int CColourListBox::InsertColumn( int nCol, LPCTSTR lpszColumnHeading, int nFormat, int nWidth, int nSubItem)
...
BOOL CColourListBox::DeleteColumn( int nCol )
{
...
// ** SetColumnOrderArray **
// *************************
BOOL CColourListBox::SetColumnOrderArray( int iCount, LPINT piArray )
...
BOOL CColourListBox::SortItems( PFNLVCOMPARE pfnCompare, DWORD dwData )
...
// ** FindItem **
// **************
int CColourListBox::FindItem( LV_FINDINFO* pFindInfo, int nStart)
{	/*
...
void CColourListBox::SetItemTxtColor(int nItem,int nSubItem,COLORREF txtColor,bool redraw)
...
void CColourListBox::SetItemBgColor(int nItem,int nSubItem,COLORREF txtBgColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nItem,0,&pItem);
...
void CColourListBox::SetItemStyle(int nItem,int nSubItem,DWORD Style,bool redraw)
{
	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
...
void CColourListBox::SetItemFont(int nItem,int nSubItem,CFont * pFont,bool redraw)
{
	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
...
// *****************************************
void CColourListBox::SetItemSelectedStyle(int nItem,int nSubItem,DWORD Style,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nItem,0,&pItem);
...
void CColourListBox::SetItemSelectedTxtColor(int nItem,int nSubItem,COLORREF txtColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nItem,0,&pItem);
...
void CColourListBox::SetItemSelectedBgColor(int nItem,int nSubItem,COLORREF txtBgColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nItem,0,&pItem);
...
void CColourListBox::SetItemSelectedFont(int nItem,int nSubItem,CFont * pFont,bool redraw)
{
	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
...
// *******************************
void CColourListBox::SetRowStyle(int nRow,DWORD Style,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
...
void CColourListBox::SetRowTxtColor(int nRow,COLORREF txtColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
void CColourListBox::SetRowBgColor(int nRow,COLORREF txtBgColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
void CColourListBox::SetRowFont(int nRow,CFont * pFont,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
// ****************************************
void CColourListBox::SetRowSelectedStyle(int nRow,DWORD Style,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
void CColourListBox::SetRowSelectedTxtColor(int nRow,COLORREF txtColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
void CColourListBox::SetRowSelectedBgColor(int nRow,COLORREF txtBgColor,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
void CColourListBox::SetRowSelectedFont(int nRow,CFont * pFont,bool redraw)
{	// We must retrieve the Style info structure of this item
	//
	LVITEM pItem;
	InitLVITEM(nRow,0,&pItem);
...
// **********************************
void CColourListBox::SetColStyle(int nCol,DWORD Style,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
void CColourListBox::SetColTxtColor(int nCol,COLORREF txtColor,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
void CColourListBox::SetColBgColor(int nCol,COLORREF txtBgColor,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
void CColourListBox::SetColFont(int nCol,CFont * pFont,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
// *******************************************
void CColourListBox::SetColSelectedStyle(int nCol,DWORD Style,bool redraw)
{
...
void CColourListBox::SetColSelectedTxtColor(int nCol,COLORREF txtColor,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
void CColourListBox::SetColSelectedBgColor(int nCol,COLORREF txtBgColor,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
void CColourListBox::SetColSelectedFont(int nCol,CFont * pFont,bool redraw)
{
	// Verify if a style for this Row already exist or not
	//
	LS_item * lpLS_col = NULL;
...
// *********************************
void CColourListBox::SetHighlightTextColor(COLORREF Color)
{	this->m_highlighttext = Color; }

void CColourListBox::SetHighlightColor(COLORREF Color)
{	this->m_highlight = Color; }

// ******************************************
// ** Internal Methods for Drawing Process **
// ******************************************
void CColourListBox::OnCustomdraw(NMHDR* pNMHDR, LRESULT* pResult)
{
...
CFont * CColourListBox::FontForItem(int nItem,int nSubItem,LPARAM lParam,NMLVCUSTOMDRAW* pNMLVCUSTOMDRAW)
{
...
CFont * CColourListBox::SelectFont(CFont * pCFont1,CFont * pCFont2,CFont * pCFont3)
{	if(pCFont1)
	{	if(!pCFont2 && ! pCFont3)
			return pCFont1;
		else
...
CFont * CColourListBox::MergeFont(CFont * pCFont1,CFont * pCFont2,CFont * pCFont3)
...
void CColourListBox::MergeLogFont(LOGFONT * font,LOGFONT * dest)
{
...
CFont * CColourListBox::CreateFont(DWORD StyleFlag)
{
...
// **************************************
void CColourListBox::Init_LS_item(LS_item * lpLS_item,bool allow_subitems)
{	// lParam Init
	//
	lpLS_item->lParam = 0;
...
void CColourListBox::Free_LS_font(LS_item* lpLS_item,DWORD mask)
{
...
void CColourListBox::Free_LS_item(LS_item* lpLS_item)
{
	if(lpLS_item == NULL)
		return;
...
void CColourListBox::InitLVITEM(int nItem,int nSubItem,LVITEM * pItem)
{ /*
  typedef struct _LV_ITEM {
    UINT   mask;         // see below
    int    iItem;        // see below
