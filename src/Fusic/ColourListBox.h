// "CColourListBox" by ANDRE Sébastien @2002 (maximus@oreka.com) (http://divxdede.fr.st)
//
...
// -- CColourListBox --
// ---------------------
class CColourListBox : public CListCtrl
{
public:
	// -- Construction --
	//
